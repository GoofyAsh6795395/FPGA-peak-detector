...
What's contained here is not only source code itself, also the project plan and related exercises.
...
In general, the desired function on FPGA is to find the peak value from the generated sequence, then do correspoonding operations based on the input from PuTTY.
