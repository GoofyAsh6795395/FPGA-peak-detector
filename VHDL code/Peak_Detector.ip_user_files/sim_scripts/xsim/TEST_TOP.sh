...
#
# Script generated by Vivado on Mon Feb 09 19:03:52 +0000 2026
...
#
# Usage        : TEST_TOP.sh
#                TEST_TOP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TEST_TOP.sh [-reset_run]
#                TEST_TOP.sh [-reset_log]
#                TEST_TOP.sh [-help]
#
...
# script info
echo -e "TEST_TOP.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TEST_TOP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot TEST_TOP xil_defaultlib.TEST_TOP xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TEST_TOP.wdb xsim.dir libdpi.so)
...
Usage: TEST_TOP.sh [-step]\n\
Usage: TEST_TOP.sh [-lib_map_path]\n\
Usage: TEST_TOP.sh [-reset_run]\n\
Usage: TEST_TOP.sh [-reset_log]\n\
Usage: TEST_TOP.sh [-keep_index]\n\
