...
entity rx_handshaker_tb is
end entity;

architecture sim of rx_handshaker_tb is
...
begin
	dut: rx_handshaker port map (clk_tb, reset_tb, oe_tb, fe_tb, valid_tb, done_tb, data_in_tb, euqueue_req_tb, data_out_tb);
